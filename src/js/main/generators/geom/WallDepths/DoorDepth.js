...
import sort_ccw from "../calculus/sort_ccw";

export default class DoorDepth{
    ...
    create ( door ) {
        ...
        if (this._created.includes(door.id)) return;
        ...
        let p = sort_ccw.sort(door.points.map(p => new Vector2(p[0], p[1])));
